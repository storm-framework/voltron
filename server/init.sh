...
stack run -- add-class --institution=UCSD  --classname=CSE230 --instructor=rjhala@eng.ucsd.edu
stack run -- add-class --institution=UCSD  --classname=CSE130 --instructor=rjhala@eng.ucsd.edu
